...
$(function () {
        $('#tempcontainer').highcharts({
            chart: {
                type: 'spline',
				backgroundColor:'rgba(221, 223, 225, 0.9)'
            },
            title: {
                text: 'Temperature'
            },
			...
			<h2>Date-Range Select</h2>
			  <p>
			  	...
			  	<form action="?site=statistics&locid=<?php echo $locationid ?>" method="post">
					...
					<input name="from" style="margin-left:auto; margin-right:0; width:75%" type="text" id="from" value="<?php if(isset($_POST['from'])) echo $_POST['from']; ?>" /><br />
                    <label for="until">until:</label>
                    <input name="until" style="margin-left:auto; margin-right:0; width:75%" type="text" id="until" value="<?php if(isset($_POST['until'])) echo $_POST['until']; ?>" /><br />
                    <label for="groupby">Group Data:</label>
